        ...
        <main className="pa4 white-80">
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              <legend className="f1 fw6 ph0 mh0 white" id="font">
                Sign In
              </legend>
              <div className="mt3">
                <label
                ...
                <input
                  className="pa2 input-reset ba b--white bg-transparent hover-bg-white hover-black w-100 white"
                  type="email"
                  name="email-address"
                  id="email-address"
              ...
              <div className="mv3">
                ...
                <input
                  className="b pa2 input-reset ba b--white bg-transparent hover-bg-white hover-black w-100 white"
                  type="password"
                  name="password"
                  id="password"
